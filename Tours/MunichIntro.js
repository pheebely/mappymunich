  ...
  features: [
    ...
    },
    {
      ...
      properties: {
        ...
        Hours: "Oct-Apr, Mo-Fr 10:00-17:00 <br> May-Sep, 10:00-19:00",
        MustSee: '<i class="fa-solid fa-fire"></i>',
        wheelchair: '<i class="fa-brands fa-accessible-icon"></i>',
        Description:
          "With its ornate, Neo-Gothic facade, the Neues Rathaus (New Town Hall) at Marienplatz (square) looks slightly older than it actually is. As a matter of fact, initial construction took place between 1867 and 1905 after the neighbouring Altes Rathaus (Old Town Hall) became too small for Munich’s city council. <br><br> One of the most important attractions is the Glockenspiel in the hall's tower, whose daily performances at 11 a.m. and 12 a.m. (and 5 p.m. in the summer months) attract audiences from around the world.",
        image:
          "src='../images/neuesrathaus.jpg' alt='Neues Rathause building from the front in Munich Germany'",
        imgsource: "Jörg Lutz",
        ...
        stroller: null,
        image2:
          "src='https://www.muenchen-tourismus-barrierefrei.de/images/stories/rampe-rathausturm.klein.jpg'",
      },
    ...
    },
    {
      ...
      properties: {
        ...
        wheelchair: '<i class="fa-brands fa-accessible-icon"></i>',
        Description:
          "The Hofbräuhaus is probably the best-known “watering hole” in Munich. Dating all the way back to 1589, this beer hall was founded by the Duke of Bavaria, Wilhelm V, and originally, surprisingly enough, was not open to the public. Luckily for today's tourists and locals, though, in 1828 it finally opened up to the masses. Today, this hospitable spot, thick with traditional atmosphere and friendly vibes, is where you can come to enjoy typical Bavarian food to your heart's content, listen to the Oompah band play loudly on stage, and gulp down the rich Hofbräuhaus beer in large, one-liter steins, which the Germans call a Mass.<br><br>Renowned for its beer, Hofbräuhaus also made mark in history on 24 February 1920, when Adolf Hitler held here one of his first propaganda gatherings.",
        image:
          "src='https://www.munich.travel/var/ger_muc/storage/images/_aliases/stage_large/9/9/5/5/265599-1-ger-DE/film-hofbrauhaus-02-foto-redline-enterprises-sm-3000.jpg'",
        imgsource: "simplyMunich",
        Website: "https://www.hofbraeuhaus.de/de/willkommen.html",
        wc: '<i class="fa-solid fa-restroom"></i>',
        MVV: "By public transport: The tram stop Nationaltheater of line 19 is not far away.\nBy car: better not.",
        Access:
          "Access through the main entrance is problem-free. You have to go through a hinged door first, stop on the right, which strikes inwards (180cm clear width) and then through a very large (400x400cm) porch and another door, just like the first. The guest rooms on the first floor can be continuously reached by kitchen lift (door 130 cm, cabin 130x105cm). There is another lift, but to use it, you have to overcome a 7cm level.",
        parking: '<i class="fa-solid fa-square-parking"></i>',
        parking_text:
          "In Maximilianstraße at the Nationaltheater,  north side, height stage entrance, 300 m away, five wheelchair parking spaces are designated.",
        Phone: "+49 89 290136 129",
        guideDog: '<i class="fa-solid fa-dog"></i>',
      },
      geometry: { type: "Point", coordinates: [11.579815, 48.137665] },
    },
    {
      type: "Feature",
      properties: {
        ...
        Number: 6,
        Type: "Shopping",
        Address: "Maximilianstr. 16, 80539 München",
        Hours: "Open 24 Hours",
        MustSee: " ",
        wheelchair: '<i class="fa-brands fa-accessible-icon"></i>',
        Description:
          "Maximilian street (Maximilianstraße) is one of the main streets of Munich and one of the most glamorous and luxurious streets in Germany. Maximilianstraße is one of Munich's four royal avenues, along with Brienner Straße, Ludwigstraße and Prinzregentenstraße. It starts at Max-Joseph-Platz, home to the Residenz and the National Theatre, and runs east-west. You can stroll wonderfully here,  enjoy the flair of the street and marvel at the noble pieces in the artfully decorated shop windows.",
        image:
          "src='https://upload.wikimedia.org/wikipedia/commons/thumb/2/26/Maximilianstraße_München_2006.jpg/640px-Maximilianstraße_München_2006.jpg' alt='Maximilianstrasse during the day.'",
        imgsource: "Wikipedia.org",
        Website:
          "https://www.muenchen.de/sehenswuerdigkeiten/maximilianstrasse",
        Access: "Wide sidewalks,  pedestrian friendly.",
        parking: '<i class="fa-solid fa-square-parking"></i>',
        parking_text:
          "At the Nationaltheater,  north side, height stage entrance, 300 m away, five wheelchair parking spaces are designated. Street parking also available.",
      },
      geometry: { type: "Point", coordinates: [11.580089, 48.139152] },
    },
    {
      type: "Feature",
      properties: {
        ...
        Hours: "Garden: Open 24 Hours<br>Museum: Mo-Su 10:00-17:00",
        MustSee: '<i class="fa-solid fa-fire"></i>',
        wheelchair: '<i class="fa-brands fa-accessible-icon"></i>',
        Description:
        ...
        image:
          "src='https://www.schloesser.bayern.de/bilder/schloss/objektseiten_790/mu_res790.jpg'",
        imgsource: "Bayerische Schlösserverwaltung / Rainer Herrmann",
        Website: "https://www.residenz-muenchen.de/englisch/tourist/index.htm",
        wc: '<i class="fa-solid fa-restroom"></i>',
        MVV: "S1-S8 (from the main station to get off to the left!), U3, U6, Bus 132 Marienplatz, U3-U6, Bus 100, 153, N40, N41, N45 Odeonsplatz, Tram 19, N19 Nationaltheater.",
        Access:
          "Users of wheelchairs need assistance! Group guided tours for persons with walking disabilities and sight impaired on special arrangement with the chateau administration. The king's building is accessible from Max-Joseph-Platz, you need assistance of the staff for the elevator.\nCuvillies-Theater: at ground level via Brunnenhof (cobblestone pavement!), bell 85 cm high, elevator to the first balcony.",
        parking: '<i class="fa-solid fa-square-parking"></i>',
        parking_text:
          "5 spaces in Maximilianstraße 8,<br>2 spaces at Max-Joseph-Platz 2",
        Phone: "+49 89 29067-1",
        elevator: '<i class="fa-solid fa-elevator"></i>',
        guidedTour: '<i class="fa-solid fa-flag"></i>',
        image2: null,
      },
      geometry: { type: "Point", coordinates: [11.578246, 48.140292] },
    },
    {
      type: "Feature",
      properties: {
    ...
    },
    {
      ...
      properties: {
        ...
        image:
          "src='https://www.munich.travel/var/ger_muc/storage/images/_aliases/stage_medium/4/2/3/9/69324-1-ger-DE/theatinerkirche-innen-sonne-foto-sven-kolb-3000.jpg'",
        imgsource: "simplyMunich",
        Website: "http://www.theatinerkirche.de/",
        MVV: "U3-U6, Bus 100, 153, N40, N41, N45 Odeonsplatz",
        Access:
          "Ground level at the right entrance, electric door opener 85 cm high. Inside electric door opener 85 cm high to the nave.",
        parking: '<i class="fa-solid fa-square-parking"></i>',
        parking_text:
          "2 spaces Salvatorplatz 2, underground parking Am Salvatorplatz",
        Phone: "+49 89 2106960",
        image2:
          "src='https://www.muenchen-tourismus-barrierefrei.de/images/theatinerkirche-eingang-rechts.klein.jpg'",
      },
      geometry: { type: "Point", coordinates: [11.577134, 48.141978] },
    },
    {
      type: "Feature",
      properties: {
        ...
        wheelchair: '<i class="fa-brands fa-accessible-icon"></i>',
        Description:
          "The Hofgarten (Royal Garden) at the Residenz palace is an idyllic green park on the edge of Munich’s historic old town. At the centre of the park, you will find a pavilion, popularly known as Diana Temple. The delicate,  dodecagonal pavilion,  which features eight entrance archways, was created by Heinrich Schön the Elder in 1615.  Right beside it,  you can also visit the Munich Residenz,  the largest inner-city palace in Germany.",
        image:
          "src='https://www.muenchen.de/sites/default/files/styles/3_2_w1216/public/2022-06/HOFGARTEN%20OBEN%204343.jpg?h=08b866d1'",
        imgsource: "Maximilian Linner / Shutterstock.com",
        Website: "https://www.residenz-muenchen.de/deutsch/hofgart/index.htm",
        wc: '<i class="fa-solid fa-restroom"></i>',
        MVV: "U3-U6, Bus 100, 153, N40, N41, N45 Odeonsplatz",
        Access:
          "Stepless via Odeonsplatz and Galeriestraße,  steep drive-up coming from Marstallplatz.  Nearest barrier-free WC: Restaurant Koi and Café Luitpold (both are accessible from the front,  right and left).",
        parking: '<i class="fa-solid fa-square-parking"></i>',
        parking_text: "underground parking Am Salvatorplatz",
      },
      geometry: { type: "Point", coordinates: [11.581422, 48.14236] },
    },
    {
      type: "Feature",
      properties: {
        ...
        wheelchair: '<i class="fa-brands fa-accessible-icon"></i>',
        Description:
          "The Monopteros, the Eisbach wave and many beer gardens\n\nToday, the people of Munich love the English Garden: on nice days they enjoy the sun on the meadows, play football or go for a walk. In winter, with good snow conditions and cold temperatures, you can even go cross-country skiing here or skate your laps on the Kleinhesseloher See lake. Or go sledding on the Monopteros hill. The view from this Greek-like temple is worthwhile at any time of year, because you have all the most important sights of Munich city centre at a glance: the Frauenkirche, the Theatinerkirche and the City Hall.",
        image:
          "src='https://www.munich.travel/var/ger_muc/storage/images/_aliases/stage_large/5/2/5/1/521525-1-ger-DE/englischer-garten-mit-stadtpanorama-2171s-foto-joerg-lutz.jpg'",
        imgsource: "Jörg Lutz",
        Website:
          "https://www.schloesser.bayern.de/deutsch/garten/objekte/mu_engl.htm",
        wc: '<i class="fa-solid fa-restroom"></i>',
        MVV: "U3, U6, Bus 58, 68, 153, 154, N40, N41, N45 Universität, Bus 100 Haus der Kunst, Bus 54, 58, 68, 154, N43, N44 Chinesischer Turm, Bus 187 Rümelinstraße",
        Access:
          'The ways in the park are covered with asphalt or gravel and suitable for wheelchairs.  barrier-free WC in the Zum Aumeister, in the Hirschau, at the Chinese Tower, in the Seehaus and in "Tivoli Pavillon" (Gyßlingstraße 10, next to Hirschau. WC accessible from left, front 80 cm,  grab handle only left.  Staff opens the door).',
        parking: '<i class="fa-solid fa-square-parking"></i>',
        parking_text:
          'Behind the museum Haus der Kunst and at the beer gardens (see "WC" below)',
      },
      geometry: { type: "Point", coordinates: [11.583641, 48.144495] },
    },
    {
      type: "Feature",
      properties: {
        Latitude: 48.1434189,
        Longitude: 11.5877449,
        Name: "Surfer's Site at the Eisbach",
        Number: 12,
        Type: "Park",
        Address: "Prinzregentenstraße opposite number 22 in 80538 Munich",
        Hours: "Open 24 hours",
        MustSee: '<i class="fa-solid fa-fire"></i>',
        wheelchair: '<i class="fa-brands fa-accessible-icon"></i>',
        Description:
          "The waves on the man-made Eisbach river at the entrance to the Englischer Garten (park) attract surfers and onlookers from around the world. The spot is famous throughout the world for being the largest, best and most consistent city centre location for river surfing.  People have been surfing here for 40 years.  ",
        image:
          "src='https://www.munich.travel/var/ger_muc/storage/images/_aliases/stage_large/0/2/7/2/1322720-1-ger-DE/rundgang-muenchen-74a7830-foto-frank-stolle-sm-3000.jpg' alt='Surfer at the Eisbach River'",
        imgsource: "Frank Stolle",
        Website: "https://www.muenchen.travel/pois/sport-freizeit/eisbachwelle",
        wc: null,
        Access:
          "Wheelchair friendly viewing from the bridge on Prinzregentenstrasse.",
        parking: null,
        parking_text: null,
        Phone: null,
        elevator: null,
      ...
      geometry: {
        type: "Point",
        coordinates: [11.587745757417512, 48.143418882923648],
      },
    },
  ],
};
