...
// Function for Toggle Layer buttons
function toggleLayers() {
  ...
  const toggleableLayers = [
    ...
    {
      id: ["englisch_garten"],
      displayLabel: "Englischer Garten Trail"
    },

    {
      id: ["district-label", "district-line"],
  ...
  for (const layer of toggleableLayers) {
    ...
    link.onclick = function (e) {
      ...
      const clickedLayers = clickedLayer.split(',');
      console.log(clickedLayer) // This is printing in the console to show clickedLayer is still a string
      console.log(clickedLayers) //Split the string by ',' into an array
