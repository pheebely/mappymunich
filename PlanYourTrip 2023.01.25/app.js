...
function createPopup(currentFeature) {
  ...
  new mapboxgl.Popup({ closeOnClick: true })
    ...
    .setHTML('<h3><a href=" ' + currentFeature.properties[config.popupInfo2] + ' ">' + currentFeature.properties[config.popupInfo] + '</a></h3>' + '<p>' + currentFeature.properties[config.popupInfo4] + '</p>' + '<p>' + currentFeature.properties[config.popupInfo3] + '</p>')
    .addTo(map);
}
